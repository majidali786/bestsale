...
class Image_nation {
    ...
    public $_source_directory;
    public $_parent_directory;
	...
	public function clear_source_directory()
    {
        $this->_source_directory = "";
        $this->_parent_directory = "";
        return TRUE;
    }
	public function set_source_directory($path)
    {
        $this->_source_directory = $path;
        $this->_parent_directory = $path;
        return TRUE;
    }
