...
<span class="caption-subject font-white bold uppercase">Add Sub Group</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Sub Group">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Sub Group</span>
</div>
<div class="actions">
