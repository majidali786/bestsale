...
<span class="caption-subject font-white bold uppercase">Add Account Group</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Account Group">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Account Group</span>
</div>
<div class="actions">
