...
<span class="caption-subject font-white bold uppercase">Add Main Group</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Main Group">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Main Group</span>
</div>
<div class="actions">
