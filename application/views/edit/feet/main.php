...
<span class="caption-subject font-white bold uppercase">Add Feet</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Feet">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Feet</span>
</div>
<div class="actions">
