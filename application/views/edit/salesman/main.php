...
<span class="caption-subject font-white bold uppercase">Add Salesman</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Salesman">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Salesman</span>
</div>
<div class="actions">
