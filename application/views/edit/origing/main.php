...
<span class="caption-subject font-white bold uppercase">Add Origing</span>
</div>
</div>
...
<label class="col-md-3 control-label">Origing</label>
<div class="col-md-9 show-error">
<input type="text" class="form-control" name="name" placeholder="Origing">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Origing</span>
</div>
<div class="actions">
