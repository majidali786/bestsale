...
<td>
<a href="javascript:" class="btn btn-sm blue edit" data-id="<?= $a['USERNAME'];?>"><i class="icon-pencil"></i></a>
<a href="javascript:" class="btn btn-sm red delete" data-id="<?= $a['USERNAME'];?>"><i class="icon-trash"></i></a>
</td>
</tr>
<?php
endforeach;
