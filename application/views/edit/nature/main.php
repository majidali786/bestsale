...
<span class="caption-subject font-white bold uppercase">Add Nature</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Nature">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Nature</span>
</div>
<div class="actions">
