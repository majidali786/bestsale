...
<span class="caption-subject font-white bold uppercase">Add Product Group</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Product Group">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Product Group</span>
</div>
<div class="actions">
