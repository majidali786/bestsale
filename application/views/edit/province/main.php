...
<span class="caption-subject font-white bold uppercase">Add Province</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Province">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Province</span>
</div>
<div class="actions">
