...
<span class="caption-subject font-white bold uppercase">Add Outer Dia</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Outer Dia">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Outer Dia</span>
</div>
<div class="actions">
