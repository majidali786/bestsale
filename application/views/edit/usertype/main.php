...
<span class="caption-subject font-white bold uppercase">Add User Type</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="User Type">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List User Type</span>
</div>
<div class="actions">
