...
<span class="caption-subject font-white bold uppercase">Inner Dia</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Inner Dia">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Inner Dia</span>
</div>
<div class="actions">
