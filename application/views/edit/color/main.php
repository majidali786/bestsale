...
<span class="caption-subject font-white bold uppercase">Add Color</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Color">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Color</span>
</div>
<div class="actions">
