...
<tr>
<th style="text-align:center;width:300px;">Product Description</th>
<th style="text-align:center;width:80px;">Unit</th>
<th style="text-align:center;width:120px;">Qty</th>
<th style="text-align:center;width:120px;">F.C Rate</th>
<th style="text-align:center;width:120px;">F.C Amount</th>
<th style="text-align:center;width:120px;">درهم Rate</th>
<th style="text-align:center;width:120px;">درهم Amount</th>
</tr>
</thead>
<tbody>
<tr>
...
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-3 row-end" name="rate" placeholder="F.C Rate"  data-position="3" >
</td>
<td><input type="text" data-required data-only-numbers greater-then-zero data-sum="tamount" class="form-control" name="amount" readonly placeholder="F.C Amount">
</td>

<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-4 row-end" name="drate" placeholder="درهم Rate"  data-position="4" >
</td>
<td><input type="text" data-required data-only-numbers greater-then-zero data-sum="dtamount" class="form-control" name="damount" readonly placeholder="درهم Amount">
</td>
