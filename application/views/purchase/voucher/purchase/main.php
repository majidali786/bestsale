...
<td class="image-preview">				
 <input type="file" name="img_e"  class="form-control" id="img_e" accept="image/*" class="image-input" />
...
baseUrl="<?= base_url("purchase/purchase")?>";		
img_url="<?= base_url("order/design")?>";		
});
...
$(document).on("keyup","[name=design]",function(){
autocomplete(document.getElementById("myInput"), countries);
});
<?php
	$contry=array();
foreach($design as $desng){
	array_push($contry,$desng['NAME']);
}
	?>
var countries = <?php echo json_encode($contry); ?>;
