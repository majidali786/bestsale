...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" name="remarks"  placeholder="Remarks">
</div>
</div>
</div>
<div class="col-sm-2">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-to-row move-enter-5" data-position="5" name="crdays"  placeholder=" Credit.Days">
</div>
</div>
</div>
</div>
...
<tr>
<th>#</th>
<th style="width:40%;text-align:center;">Product</th>
...
var val=$(this).val();	
if(val!=""){
$.get("<?= base_url('data/party-data');?>",{vcode:val},function(response){
