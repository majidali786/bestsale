...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-to-row move-enter-6" data-position="6" name="crdays" value="<?= $data[0]['CRDAYS']?>"  placeholder="Credit.Days">
</div>
</div>
</div>
</div>
...
<tr>
<th>Sr#</th>
<th style="width:40%;text-align:center";>Product Description</th>
<th style="width:12%;text-align:center";>Design</th>
...
<tr data-id="<?= $rowNumber;?>">
    ...
    <td><span><?= $row['PNAME'];?></span>
	 ...
	 <td><span><?= $row['DESIGN'];?></span>
        <input type="hidden" name="design_<?= $rowNumber;?>" value="<?= $row['DESIGN'];?>" readonly class="form-control">
    </td> <td><span><?= $row['COLOR'];?></span>
        <input type="hidden" name="color_<?= $rowNumber;?>" value="<?= $row['COLOR'];?>" readonly class="form-control">
    </td> <td><span><?= $row['SIZE'];?></span>
        <input type="hidden" name="size_<?= $rowNumber;?>" value="<?= $row['SIZE'];?>" readonly class="form-control">
    </td>
    <td><span><?= $row['UNIT'];?></span>
        <input type="hidden" name="unit_<?= $rowNumber;?>" value="<?= $row['UNIT'];?>" readonly class="form-control">
    </td>
