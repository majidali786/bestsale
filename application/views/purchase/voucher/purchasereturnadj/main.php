...
<th style="width:150px;text-align:center">GST %</th>
<th style="width:150px;text-align:center">GST Rs.</th>
<th style="width:150px;text-align:center">Net</th>
</tr>
</thead>
<tbody>
<tr>
...
<td><input type="text" data-required data-only-numbers greater-then-zero class="form-control th-right" name="gstper_e" readonly></td>
<td><input type="text" data-required data-only-numbers greater-then-zero class="form-control th-right" name="gst_e" readonly placeholder="GST"></td>
...
baseUrl="<?= base_url("purchase/purchase-return-adj")?>";	
<?php 
