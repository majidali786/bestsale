...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-2" data-position="2" input-mask-date name="vdate" value="<?= $vdate?>" style="text-align:center"  placeholder="dd/mm/yyyy">
</div>
</div>
</div>
<div class="col-sm-4">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-to-row move-enter-6" data-position="6" name="crdays"  placeholder="Delivery Days">
</div>
</div>
</div>
<div class="col-sm-2">
...
<tr>
<th>Sr#</th>
<th style="text-align:center;width:45%";>Design</th>
...
<td  class="show-error"><input type="text" input-mask-date class="form-control move-enter-up move-enter-17" data-position="17" name="bdate" 
value="<?= $bdate?>"  placeholder="dd/mm/yyyy"></td>
...
<td  class="show-error"><input type="text" data-only-numbers class="form-control move-enter-up move-enter-12" data-position="12" data-dmas="tamount-add,
...
<td><input type="text" class="form-control theme-bg" readonly name="net"  value="0"  placeholder="Invoice Total"></td>
</tr>
<tr class="theme-bg">
...
<td></td>
<td></td>
<td><input type="text" class="form-control theme-bg" readonly name="previous" value="0" placeholder="Previous"></td>
<td><input type="text" class="form-control theme-bg" readonly name="current" value="0"  placeholder="Current"></td>
<td><input type="text" class="form-control theme-bg" readonly name="total" value="0"  placeholder="Total"></td>
</tr>
</table>
</div>
</div>
