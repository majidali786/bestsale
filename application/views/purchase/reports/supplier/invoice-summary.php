...
<span class="caption-subject font-white bold uppercase">Supplier Invoice Clearing Summary Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("supplier-reports/invoice-summary/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
	...
	<div class="col-sm-6">
	<div class="form-group">
	<label class="control-label col-md-3">Supplier <i class="icon-user theme-color"></i></label>
