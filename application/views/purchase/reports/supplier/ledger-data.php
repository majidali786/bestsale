...
?>
<h3><i class="icon-user theme-color"></i><i class="icon-calendar theme-color"></i><button type="button" 
class="btn green pull-right" style="margin-left:5px;" print print-type="report" print-format="pdf"  print-name="" ><i class="icon-printer">
</i> Pdf</button> <button type="button" class="btn green pull-right" print print-type="report" print-format="xls"  print-name="suptlgr" ><i class="icon-printer"></i> Excel</button>
</h3>
...
<td Style="text-align:left"><?= $branch[$a['B_ID']];?></td>
</tr>
<?php
$sr++;
