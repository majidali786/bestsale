...
<span class="caption-subject font-white bold uppercase">Supplier Balances Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("supplier-reports/balance/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
