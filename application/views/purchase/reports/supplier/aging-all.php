...
<span class="caption-subject font-white bold uppercase">Supplier Aging Report(All)</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("supplier-reports/aging-all/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
