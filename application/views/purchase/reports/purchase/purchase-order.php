...
<span class="caption-subject font-white bold uppercase">Purchase Order Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("purchase-reports/purchase-order/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
	<div class="form-body">
	<div class="row">
	<div class="col-sm-6">
