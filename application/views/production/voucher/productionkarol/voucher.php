...
<div class="col-md-12 show-error">
<select name="lotno" id="lotno" class="form-control select2 move-enter-up move-enter-3" data-position="3">
<option value="">Select Lot No.</option>
<?php 
if(count($lotno)){
foreach($lotno as $g){
?>
<option value="<?= $g['LOTNO'];?>"><?= $g['LOTNO']; ?></option>
<?php
}
}
?>
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-6" data-position="6" name="cused" data-only-numbers placeholder="Currently Used(QTY)">
</div>
</div>
</div>
<div class="col-sm-8">
