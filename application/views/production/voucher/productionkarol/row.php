...
<td>
<input type="text"  class="form-control move-enter-row enter-3" name="weight"  placeholder="Weight" data-sum="twght" data-required data-only-numbers   data-position="3">
</td>
<td>
