...
<td>
<input type="text"  class="form-control move-enter-row enter-3" name="weight"  placeholder="Weight" data-sum="twght" data-required data-only-numbers onkeyup="tot()" data-position="3">
</td>
<td>
<input type="text" data-required data-only-numbers  onkeyup="tot()" class="form-control move-enter-row enter-4" name="qty" data-sum="tqty" placeholder="Qty" data-position="4">
</td>
<td>
<input type="text"  data-required data-only-numbers class="form-control move-enter-row enter-5" name="feet" placeholder="Feet"  data-position="5">
</td>
<td>
<input type="text"  data-required data-only-numbers class="form-control" name="totweight" placeholder="Total Weight" readonly data-sum="totwght">
</td>
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-6 row-end" name="rate" data-dmas="totweight-add,rate-multiply,amount-result" placeholder="Rate"  data-position="6" >
</td>
