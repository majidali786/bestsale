...
<span class="caption-subject font-white bold uppercase">Add Indentor</span>
</div>
</div>
...
<label class="col-md-3 control-label">Indentor</label>
<div class="col-md-9 show-error">
<input type="text" class="form-control" name="name" placeholder="Indentor">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Indentor</span>
</div>
<div class="actions">
