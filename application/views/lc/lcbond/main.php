...
<span class="caption-subject font-white bold uppercase">Add Lc Bond</span>
</div>
</div>
...
<label class="col-md-3 control-label">Lc Bond</label>
<div class="col-md-9 show-error">
<input type="text" class="form-control" name="name" placeholder="Lc Bond">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Lc Bond</span>
</div>
<div class="actions">
