...
<td>
<select name="unit" id="unit" data-required class="form-control select2 move-enter-row enter-2" data-position="2">
...
<td>
<select name="lcno" id="lcno" data-required class="form-control select2 move-enter-row enter-3" data-position="3">
...
<td>
<input type="text"  class="form-control move-enter-row enter-4" name="coil"  placeholder="Coil No." data-required data-position="4">
</td>
<td>
<input type="text"  class="form-control move-enter-row enter-5" name="weight"  placeholder="Weight"  data-sum="tweight" data-required data-only-numbers   data-position="5">
</td>
<td>
<input type="text" data-required data-only-numbers  class="form-control move-enter-row enter-6" name="qty" data-sum="tqty" placeholder="Qty"  data-position="6">
</td>
<td>
