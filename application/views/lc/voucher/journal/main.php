...
<td>
<select name="lcno_e" id="lcno_e" class="form-control select2" >
...
<td><input type="text" data-required data-only-numbers if-greater-then-zero="credit_e"  class="form-control" name="debit_e" placeholder="Amount"></td>
<td><input type="text" data-required data-only-numbers if-greater-then-zero="debit_e"  class="form-control" name="credit_e" placeholder="Amount"></td>
</tr>
</tbody>
</table>
