...
<td>
<select name="lcno" id="lcno" class="form-control select2 move-enter-row enter-3" data-position="3" >
...
<td><input type="text" data-required data-only-numbers if-greater-then-zero="credit"  data-sum="tdebit" class="form-control  move-enter-row enter-4" data-position="4" name="debit" placeholder="Debit"></td>
<td><input type="text" data-required data-only-numbers  credit data-sum="tcredit" class="form-control  move-enter-row enter-5 row-end" if-greater-then-zero="debit" data-position="5" name="credit" placeholder="Credit"></td>
</tr>
</tbody>
</table>
</div>
