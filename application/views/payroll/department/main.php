...
<span class="caption-subject font-white bold uppercase">Add Department</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Department">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Department</span>
</div>
<div class="actions">
