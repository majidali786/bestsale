...
<h3 class="margin-0"><b><i class="icon-trophy"></i> Emplopyee Salary Sheet Monthly Overtime </br> From Date<i class="icon-calendar"></i> <?= date("D d/m/Y",strtotime($date1))?> To Date<i class="icon-calendar"></i> <?= date("D d/m/Y",strtotime($date2))?></b></h3>
</div>
<input type="hidden" value="7" name="tdays"/>
<input type="hidden" value="<?= $date ?>" name="fdate"/>
...
$class="";
$basic=$wdays=$hours=$ltloan=$stloan=$dadvance=0;	
foreach($data2 as $d){
if($d['ECODE']==$row['ID']){
$wdays=$d['WDAYS'];	
$hours=$d['OHOURS'];	
...
<td class="tooltips" data-container="body" data-placement="top" data-original-title="Basic Per Day Salary"><input type="text" class="form-control input-format" value="<?= $basic?>" salary-sheet name="basic_<?= $rowNo;?>"/></td>
...
<td class="tooltips" data-container="body" data-placement="top" data-original-title="Total Short Term Loan"><span class="tstl_<?= $rowNo;?>"><?= lakhseparater($shortLoan+$stloan);?></span><input type="hidden" value="<?= $shortLoan+$stloan;?>" class="tstloan" name="tstl_<?= $rowNo;?>"/></td>
...
<td class="tooltips" data-container="body" data-placement="top" data-original-title="Long Term Loan Deduction"><input salary-sheet type="text"  value="<?= $ltloan ?>" class="form-control input-format tdltloan" Placeholder="L.term Loan Ded." name="ltermded_<?= $rowNo;?>"/></td>
<td class="tooltips" data-container="body" data-placement="top" data-original-title="Short Term Loan Deduction"><input salary-sheet type="text"  value="<?= $stloan ?>" class="form-control input-format tdstloan" Placeholder="S.term Loan Ded." name="stermded_<?= $rowNo;?>"/></td>
<td class="tooltips" data-container="body" data-placement="top" data-original-title="Advance Deduction"><input salary-sheet type="text"  value="<?= $dadvance ?>" class="form-control input-format tdavance" Placeholder="Advance Ded." name="advanceded_<?= $rowNo;?>"/></td>
