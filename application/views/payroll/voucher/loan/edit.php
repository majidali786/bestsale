...
<div class="col-md-12 show-error">
<input type="text" int-numbers-only class="form-control move-enter-up move-enter-7" data-position="7" value="<?= $data[0]['LOAN']?>" data-dmas="amount-add,ninstall-divide,pminstall-result" name="amount"  placeholder="Loan / Advance Amount">
</div>
</div>
</div>
...
<div class="col-md-12 show-error">
<input type="text" class="form-control  move-enter-up move-enter-8" int-numbers-only data-position="8"  value="<?= $data[0]['NINSTALL']?>" data-dmas="amount-add,ninstall-divide,pminstall-result" name="ninstall"  placeholder="No. Of Installments">
</div>
</div>
</div>
<div class="col-sm-4 pminstall">
<div class="form-group">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-9" int-numbers-only data-position="9"  value="<?= $data[0]['PMINSTALL']?>"  name="pminstall"  placeholder="Per Month Installments">
</div>
</div>
</div>
</div>
...
if($(document).find("[name=type]").val()==3){
