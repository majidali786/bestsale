...
<table class="table table-striped table-bordered table-hover order-column" id="ledger-all-chq-data">
<thead>
<tr>
<th>Sr</th>
<th>Date</th>
...
<table class="table table-striped table-bordered table-hover order-column" id="ledger-all-chqs">
<thead>
<tr>
<th>Vr.No</th>
<th>Chq.No</th>
...
<script>
$('#ledger-all-chq-data,#ledger-all-chqs').dataTable({
                language: {
                    aria: {
