...
<span class="caption-subject font-white bold uppercase">Customer Balance Comparison (Average) Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("customer-reports/balance-comparison/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
