...
<span class="caption-subject font-white bold uppercase">Sales Person Wise Recovery(With Cheques)</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("customer-reports/sperson-wise-recovery-with-cheques/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
...
ledgerUrl="<?= base_url("customer-reports/ledger");?>";
