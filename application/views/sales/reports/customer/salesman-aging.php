...
<span class="caption-subject font-white bold uppercase">Customer Aging Report(All)</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("customer-reports/salesman-aging/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
