...
<span class="caption-subject font-white bold uppercase">Customer Aging Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("customer-reports/aging/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
