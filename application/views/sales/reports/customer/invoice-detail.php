...
<span class="caption-subject font-white bold uppercase">Customer Invoice Clearing Detail Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("customer-reports/invoice-details/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
