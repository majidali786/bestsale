...
<span class="caption-subject font-white bold uppercase">Sales Adjustment Pending Balance Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("sales-reports/salesadj-report/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
