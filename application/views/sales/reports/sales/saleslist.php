...
<span class="caption-subject font-white bold uppercase">Sales Invoice List Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("sales-reports/saleslist-report/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
