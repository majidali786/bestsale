...
<span class="caption-subject font-white bold uppercase">Sales Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("sales-reports/sales/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
	<div class="form-body">
	<div class="row">
	<div class="col-sm-6">
