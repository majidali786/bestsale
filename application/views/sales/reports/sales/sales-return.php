...
<span class="caption-subject font-white bold uppercase">Sales Return Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("sales-reports/sale-return/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
	<div class="form-body">
	<div class="row">
	<div class="col-sm-6">
	...
	<span class="inc"></span>
	<span class="check"></span>
	<span class="box"></span> <b>Party</b> </label>
	</div>
	<div class="md-radio has-error">
	...
	<span class="inc"></span>
	<span class="check"></span>
	<span class="box"></span> <b>Product</b> </label>
	</div>
	<div class="md-radio has-error">
	<input type="radio" id="ortype3" name="ortype"  value="3" class="md-radiobtn">
	<label for="ortype3">
	<span class="inc"></span>
	<span class="check"></span>
	<span class="box"></span> <b>Invoice</b> </label>
	</div>
	</div>
	</div>
	</div>
	...
	<div class="col-md-8 show-error">
	<select name="party[]"  id="party" class="form-control select2" data-allow-clear="true" data-placeholder="Select Customer" multiple>
	<?php 
	if(count($party)){
	foreach($party as $g){
	?>
