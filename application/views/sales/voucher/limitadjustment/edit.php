...
<div class="col-md-12 show-error">
<input type="text" class="form-control" value="<?= $data[0]['CLIMIT']?>" name="climit" readonly placeholder="Credit Limit">
</div>
</div>
</div>
</div>
...
<div class="col-md-12">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" name="elimit" value="<?= $data[0]['ELIMIT']?>"  placeholder="Exceed Limit.">
</div>
</div>
</div>
