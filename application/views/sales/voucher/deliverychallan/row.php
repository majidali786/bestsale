...
<td>
<input type="text" data-required data-only-numbers  class="form-control move-enter-row enter-4" name="qty" data-sum="tqty" data-dmas="conversion-add,fcrate-multiply,rate-result,clear-clear,weight-add,fcrate-multiply,fcamount-result,clear-clear,weight-add,rate-multiply,amount-result" placeholder="Qty"  data-position="4">
</td>
<td>
<input type="text"  class="form-control move-enter-row enter-5" name="weight"  placeholder="Weight" data-sum="tweight" data-dmas="conversion-add,fcrate-multiply,rate-result,clear-clear,weight-add,fcrate-multiply,fcamount-result,clear-clear,weight-add,rate-multiply,amount-result" data-required data-only-numbers   data-position="5">
</td>
<td>
<input type="text"  data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-6" data-dmas="conversion-add,fcrate-multiply,rate-result,clear-clear,weight-add,fcrate-multiply,fcamount-result,clear-clear,weight-add,rate-multiply,amount-result" name="fcrate" placeholder="F.C Rate(MT)"  data-position="6">
</td>
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-7 row-end" data-dmas="conversion-add,fcrate-multiply,rate-result,clear-clear,weight-add,fcrate-multiply,fcamount-result,clear-clear,weight-add,rate-multiply,amount-result" name="rate" placeholder="PKR Rate(MT)"  data-position="7" >
</td>
