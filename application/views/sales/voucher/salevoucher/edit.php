...
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" name="sordrno" readonly value="<?= $data[0]['SONO']?>"  placeholder="Sale Order No.">
</div>
...
<div class="col-md-5 padding-left-yes">
<input type="text" class="form-control move-enter-up move-enter-5" data-position="5" name="dcno" readonly value="<?= $data[0]['DCNO']?>" placeholder="DC No.">
</div>
<div class="col-md-7 padding-0">
<button type="button" class="btn green"><i class="icon-list"></i></button> 
<button type="button" class="btn green"><i class="icon-arrow-down"></i></button>
...
<input type="checkbox" id="dcsale" name="dcsale" <?php if($data[0]['DCNO']!=''){ echo "checked";}?>  value="1" class="md-check">
<label for="dcsale">
<span class="inc"></span>
...
<tr>
<td class="show-error"><input type="text" value="<?= $data[0]['KWEIGHT']?>" class="form-control move-enter-up move-enter-11 th-right" data-position="11" name="kweight"  placeholder="Kanta Weight"></td>
<td  class="show-error"><input type="text" value="<?= $data[0]['DISCOUNT']?>" data-only-numbers class="form-control move-enter-up move-enter-12 th-right" data-position="12" data-dmas="tamount-add,discount-minus,freight-add,loading-add,others-add,net-result,current-result,previous-add,total-result" name="discount"  placeholder="Discount"></td>
<td  class="show-error"><input type="text" data-only-numbers class="form-control move-enter-up move-enter-13 th-right" data-position="13" value="<?= $data[0]['FREIGHT']?>" name="freight" data-dmas="tamount-add,discount-minus,freight-add,loading-add,others-add,net-result,current-result,previous-add,total-result"  placeholder="Freight"></td>
<td  class="show-error"><input type="text" data-only-numbers class="form-control move-enter-up move-enter-14 th-right" data-position="14" value="<?= $data[0]['LOADING']?>" name="loading" data-dmas="tamount-add,discount-minus,freight-add,loading-add,others-add,net-result,current-result,previous-add,total-result" placeholder="Loading"></td>
<td  class="show-error"><input type="text" data-only-numbers class="form-control move-enter-up move-enter-15 th-right" data-position="15" value="<?= $data[0]['OTHERS']?>" name="others" data-dmas="tamount-add,discount-minus,freight-add,loading-add,others-add,net-result,current-result,previous-add,total-result"  placeholder="Others"></td>
<td><input type="text" class="form-control theme-bg th-right" readonly name="net"  placeholder="Net"></td>
</tr>
<tr class="theme-bg">
<th>Bilty No</th>
<th>Bilty Date</th>
...
<td  class="show-error"><input type="text" input-mask-date class="form-control move-enter-up move-enter-17" data-position="17" value="<?= $bdate?>" name="bdate"  placeholder="dd/mm/yyyy"></td>
