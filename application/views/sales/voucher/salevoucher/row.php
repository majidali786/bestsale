...
<th style="width:150px;text-align: center;">Weight</th>
...
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-5 row-end" name="rate" placeholder="Rate"  data-position="5" >
</td>
