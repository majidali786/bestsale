...
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-4 row-end" data-dmas="qty-add,rate-multiply,amount-result" name="rate" placeholder="Rate"  data-position="4" >
</td>
