...
<div class="col-md-12">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" required name="vno" style="text-align: center;" 
value="<?= $data[0]['VNO']?>"  placeholder="Sales Order No.">
</div>
</div>
</div>
<div class="col-sm-4">
...
<div class="col-md-12">
<input type="text" class="form-control move-enter-up move-enter-6" data-position="6"  name="mobile" style="text-align: left;" 
value="<?= $data[0]['MOBILE']?>"  placeholder="Mobile.">
</div>
</div>
</div>
<div class="col-sm-3">
<div class="form-group show-error">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i>Email.</label>
<div class="col-md-12">
<input type="text" class="form-control move-enter-up move-enter-7" data-position="7"  name="email" style="text-align: left;" 
value="<?= $data[0]['EMAIL']?>"  placeholder="Email.">
</div>
</div>
</div>
</div>
...
name="rect"  value="<?= $data[0]['RAMOUNT']?>" placeholder="Received Amount"></td>
...
data-dmas="tamount-add,gst-dpercent-gstamt,net-result" name="gst" value="<?= $data[0]['GST']?>" placeholder="Discount(%)"></td>
...
$("[name=saleman]").val(<?= $data[0]['SLCODE']?>);
