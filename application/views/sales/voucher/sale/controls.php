...
?>
<li><button class="tooltips print_voucher" data-control-print data-container="body" data-placement="right" 
data-original-title="Print"  print-type="voucher" print-format="pdf" print-name="sales"><i class="icon-printer text-info" ></i></button></li>
<?php 
}
}
if(!empty($voucherrights[0]['PRNT'])){
...
?>
<li><button class="tooltips print_voucher" data-control-print data-container="body" data-placement="right" 
data-original-title="Invoice Print"  print-type="voucher" print-format="pdf" print-name="sales_inv"><i class="icon-printer text-info" ></i></button></li>
<?php 
}
}
?>
