...
<h2 class="margin-0"><b><i class="icon-basket"></i> LC Purchase Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<th style="width:20%;"><b>LC No.</b></th><td><?= $data1[0]['LNCO']?></td>
</tr>
<tr>
<th><b>Party</b></th><td colspan="2"><?= $data1[0]['VCODE']." - ".$data1[0]['VNAME']?></td>
<th><b>Purchase Account</b></th><td colspan="2"><?= $data1[0]['PACODE']." - ".$data1[0]['PANAME']?></td>
</tr>
<tr>
<th><b>Address</b></th><td colspan="2"><?= $data1[0]['ADDR']?></td>
<th><b>Bond</b></th><td colspan="2"><?= $data1[0]['LCBOND']?></td>
</tr>
<tr>
<th style="width:20%;"><b>GRN No.</b></th><td><?= $data1[0]['GRN']?></td>
<th style="width:20%;"><b>GRN Date</b></th><td><?= $data1[0]['GRNDATE']?></td>
<th style="width:20%;"><b>LC Account</b></th><td><?= $data1[0]['LCNAME']?></td>
</tr>
<tr>
...
<td class="th-right"><?= number_format($row['OVERHEAD'])?></td>
<td class="th-right"><?= number_format($row['TOTAL'])?></td>
</tr>
<?php 
$rowNumber++;
$tqty+=$row['QTY'];
