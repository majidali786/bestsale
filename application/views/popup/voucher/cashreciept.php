...
<h2 class="margin-0"><b><i class="icon-basket"></i> Cash Reciept Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<td><?= $row['DESCR']?></td>
<td style="text-align:right"><?= number_format($row['DEBIT'])?></td>
</tr>
<?php 
$rowNumber++;
$tamount+=$row['DEBIT'];
...
<td style="text-align:right"><?= number_format($tamount)?></td>
</tfoot>
