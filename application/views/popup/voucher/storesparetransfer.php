...
<h2 class="margin-0"><b><i class="icon-basket"></i> Store & Spare Stock Transfer Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<tr>
<th><b>From Department</b></th><td colspan="2"><?= $data1[0]['FDEPARTMENT']?></td>
<th><b>To Department</b></th><td colspan="2"><?= $data1[0]['TDEPARTMENT']?></td>
</tr>
</table>
<table class="table table-bordered">
<tr>
