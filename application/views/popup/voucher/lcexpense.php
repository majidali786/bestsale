...
<h2 class="margin-0"><b><i class="icon-basket"></i> LC Expense : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<tr>
<th style="width:10%;"><b>Trasfer Date</b></th><td style="width:20%;"><?= date("d/m/Y",strtotime($data1[0]['TDATE']))?></td>
<th style="width:10%;"><b>Ware House</b></th><td style="width:20%;"><?= $data1[0]['LOCATION']?></td>
<th style="width:10%;"><b style="width:30%;"></b></th><td></td>
</tr>
</table>
<table class="table table-bordered">
<tr>
