...
<h2 class="margin-0"><b><i class="icon-basket"></i> Loan Advance Payment Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<th style="width:20%;"><b>To Account</b></th><td><?= $data1[0]['ACODE']."-".$data1[0]['ANAME']?></td>
</tr>
<tr>
<th><b>Type</b></th><td><?= $data1[0]['TYPE']?></td>
<th><b>Loan/Advance Amount</b></th><td><?= $data1[0]['LOAN']?></td>
<th><b>Employee</b></th><td><?= $data1[0]['ECODE']."-".$data1[0]['EMPLOYEE']?></td>
</tr>
</table>
<?php 
}
