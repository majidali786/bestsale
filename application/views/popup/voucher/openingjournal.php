...
<h2 class="margin-0"><b><i class="icon-basket"></i>Opening Journal Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<td class="th-right"><?= number_format($row['CREDIT'])?></td>
</tr>
<?php 
$rowNumber++;
$tdebit+=$row['DEBIT'];
...
<td class="th-right"><?= number_format($tdebit)?></td>
<td class="th-right"><?= number_format($tcredit)?></td>
</tfoot>
