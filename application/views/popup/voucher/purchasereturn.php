...
<h2 class="margin-0"><b><i class="icon-basket"></i> Purchase Return Voucher : <?= $branch[$data1[0]['B_ID']]?></b></h2>
</div>
...
<th><b>Purch. Return Account</b></th><td colspan="2"><?= $data1[0]['PCODE']." - ".$data1[0]['PNAME']?></td>
</tr>
<tr>
