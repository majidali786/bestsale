...
<h3><i class="icon-user theme-color"></i> : <?= $data[0]['ANAME'];?> (<?= $date1?> <i class="icon-calendar theme-color"></i> <?= $date2?>)
 <button type="button" class="btn green pull-right" style="margin-left:5px;" print print-type="report" print-format="pdf" 
 print-name="account-activity" ><i class="icon-printer"></i> Pdf</button> 
 
 <button type="button" class="btn green pull-right" print print-type="report" print-format="xls"  print-name="account-activity" ><i class="icon-printer"></i> Excel</button>
...
?>
<script>
$('#ledger-data,#chqs-data').dataTable({
                language: {
                    aria: {
