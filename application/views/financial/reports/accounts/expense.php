...
<span class="caption-subject font-white bold uppercase">Expense Activity Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("financial-reports/expense/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
	<div class="form-body row">
	<div class="col-sm-6">
	<div class="form-group">
	<label class="control-label col-md-3">As On <i class="icon-calendar theme-color"></i></label>
	<div class="col-md-9 show-error">
	<input class="form-control date-range-picker" size="16" type="text"  name="date" value="<?= "01/01/2019 - ".date("d/m/Y")?>" />
	</div>
	</div>
	</div>
