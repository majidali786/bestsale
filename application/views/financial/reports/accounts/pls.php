...
<span class="caption-subject font-white bold uppercase">Profit / (Loss) Sheet Report</span>
</div>
</div>
<div class="portlet-body">
<form action="<?= base_url("financial-reports/pls/data")?>" class="form-horizontal form-bordered action-url" data-target="[data-load-report]">
