...
<tr data-id="<?= $rowNumber;?>">
	...
	{	
	?>
	<span><?= $row['RCHQNO'].",".$row['RCHQAMT'];?></span>
        <input type="hidden" name="refChqNo_<?= $rowNumber;?>" value="<?= $row['RCHQNO'].",".$row['RCHQAMT'];?>" ajax-data class="form-control">
		<input type="hidden" name="select2val_refChqNo_<?= $rowNumber;?>" value="<?= $row['RCHQNO'].",".$row['RCHQAMT'];?>">
		<input type="hidden" name="select2show_refChqNo_<?= $rowNumber;?>" value="<?= $row['RCHQNO']." => ".$row['RCHQAMT'];?>">
	<?php 
	}
	else{
	?>
	<span></span>
    <input type="hidden" name="refChqNo_<?= $rowNumber;?>" value="" ajax-data class="form-control">
	<input type="hidden" name="select2val_refChqNo_<?= $rowNumber;?>" value="">
	<input type="hidden" name="select2show_refChqNo_<?= $rowNumber;?>" value="">
	<?php 
	}
	?>	
    </td>
    <td class="th-right"><span><?= $row['INVAMT'];?></span>
        <input type="hidden" name="invAmt_<?= $rowNumber;?>" value="<?= $row['INVAMT'];?>" class="form-control">
    </td>
    <td class="th-right"><span><?= $row['RCHQAMT'];?></span>
        <input type="hidden" name="refChqAmt_<?= $rowNumber;?>" value="<?= $row['RCHQAMT'];?>" class="form-control">
    </td>
