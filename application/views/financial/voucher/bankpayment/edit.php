...
<div class="col-sm-2">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> Bank Acc.Code<span class="required">*</span></label>
<div class="col-md-12 show-error">
<input type="text" class="form-control" value="<?= $data[0]['CACODE']?>" name="cacode" readonly placeholder="Bank Account Code">
</div>
</div>
</div>
...
<div class="col-sm-4">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> Bank Acc.Name<span class="required">*</span></label>
<div class="col-md-12 show-error">
...
<th style="text-align:center;">Chq. Date</th>
