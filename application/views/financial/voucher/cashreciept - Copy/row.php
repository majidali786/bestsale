...
<tr>
<th style="text-align-center;width:300px;">Party/Account</th>
<th style="text-align-center;width:150px;">Invoices</th>
...
<td><select name="invoices" id="invoices" value-splitter="," value-index="1"  change-assign-value="invAmt" ajax-data
 class="form-control select2 move-enter-row enter-2" data-position="2">
...
<td><input type="text" class="form-control move-enter-row enter-3" data-required data-position="3" 
...
class="form-control  move-enter-row enter-4 row-end" data-position="4" name="amount" placeholder="Amount"></td>
</tr>
</tbody>
</table>
</div>
