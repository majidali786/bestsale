...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-2 move-to-row" data-position="2" style="text-align:center;"  input-mask-date name="vdate" value="<?= $vdate?>" placeholder="dd/mm/yyyy">
</div>
</div>
</div>
...
<td class="theme-bg" style="text-align:right;"><input type="text" name="tdebit" /></td>
<td class="theme-bg" style="text-align:right;"><input type="text" name="tcredit" /></td>
</tr>
</tfoot>
</table>
</div>
