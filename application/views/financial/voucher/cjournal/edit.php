...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-2 move-to-row" data-position="2" input-mask-date name="vdate" style="text-align:center;"  value="<?= $vdate?>" placeholder="dd/mm/yyyy">
</div>
</div>
</div>
...
<th style="width:35%;text-align:center;">Party/Account</th>
<th style="width:35%;text-align:center;">Description</th>
<th style="width:13%;text-align:center;">Debit</th>
<th style="width:13%;text-align:center;">Credit</th>
</tr>
</thead>
