...
?>
<li><button class="tooltips print_voucher" data-control-print data-container="body" data-placement="right" data-original-title="Print"  print-type="voucher" print-format="pdf" print-name="jv"><i class="icon-printer text-info" ></i></button></li>
<?php 
}
}
?>
