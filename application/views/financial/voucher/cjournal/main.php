...
<td><input type="text" style="text-align:right;" data-required data-only-numbers if-greater-then-zero="credit_e"  class="form-control" name="debit_e" placeholder="Amount"></td>
<td ><input type="text" style="text-align:right;" data-required data-only-numbers if-greater-then-zero="debit_e"  class="form-control" name="credit_e" placeholder="Amount"></td>
</tr>
</tbody>
</table>
...
baseUrl="<?= base_url("financial/china-opening")?>";	
});
</script>