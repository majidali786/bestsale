<table class="table table-striped table-bordered table-hover order-column" id="pending-order-invoices">
<thead>
<tr>
<th>Sr</th>
<th>No.</th>
...
<script>
$('#pending-order-invoices').dataTable({
                language: {
                    aria: {
...
$(document).find("#pending-order-invoices").on("click",".green",function(){
