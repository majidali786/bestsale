...
<tr data-id="<?= $rowNumber;?>">
  ...
  <td><span><?= $row['INVNO'];?></span>
        <input type="hidden" name="pname_<?= $rowNumber;?>" value="<?= $row['INVNO'];?>" hidden-data="pcode_<?= $rowNumber;?>" class="form-control">
        <input type="hidden" name="pcode_<?= $rowNumber;?>" value="<?= $row['INVNO'];?>">
    </td>
    ...
    <td><span><?= $row['ANAME'];?></span>
        <input type="hidden" name="apname_<?= $rowNumber;?>" value="<?= $row['ANAME'];?>" class="form-control">
    </td>
...
<td class="theme-bg at-right1"><input type="text" name="tamount" /></td>
</tr>
</tfoot>
</table>
