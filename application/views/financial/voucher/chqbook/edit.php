...
<div class="col-sm-2">
<div class="form-group">
<label class="col-md-12 control-label"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i>  Bank<span class="required">*</span></label>
<div class="col-md-12 show-error">
<select name="bank" id="bank" class="form-control select2 move-enter-up move-enter-3" data-position="3">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" int-numbers-only name="bno" value="<?= $data[0]['BNO']?>" placeholder="Book No.">
</div>
</div>
</div>
<div class="col-sm-2">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-5" data-position="5" int-numbers-only name="starting" value="<?= $data[0]['STARTAT']?>" placeholder="Starting No.">
</div>
</div>
</div>
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-6" data-position="6" int-numbers-only name="ending" value="<?= $data[0]['ENDAT']?>" placeholder="Ending No.">
</div>
</div>
</div>
</div>
