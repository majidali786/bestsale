...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" int-numbers-only name="bno" value="" placeholder="Book No.">
</div>
</div>
</div>
<div class="col-sm-2">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-5" data-position="5" int-numbers-only name="starting" value="" placeholder="Starting No.">
</div>
</div>
</div>
<div class="col-sm-2">
...
<div class="col-md-12 show-error">
<input type="text" class="form-control move-enter-up move-enter-6" data-position="6" int-numbers-only name="ending" value="" placeholder="Ending No.">
</div>
</div>
</div>
</div>
