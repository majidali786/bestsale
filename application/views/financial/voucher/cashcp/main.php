...
<tr>
<th style="width:700px;text-align:center;">Party/Account</th>
<th style="width:700px;text-align:center;">Description</th>
<th style="width:300px;text-align:center;">درهم Amount</th>
</tr>
</thead>
<tbody>
<tr>
...
<td><input type="text" data-required data-only-numbers greater-then-zero style="text-align:right" class="form-control th-right" name="amount_e" placeholder="Amount"></td>
</tr>
</tbody>
</table>
...
baseUrl="<?= base_url("financial/cashcp")?>";	
});
