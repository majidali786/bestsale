    ...
    <div class="portlet-title" style="text-align:center;">
        <div style="margin-top:10px;">Top 5 Sales Invoices </div>
    </div>
...
<tr>
    ...
    <td style="text-align:left;"><span><?= $data['VCODE'];?></span></td>
    <td style="text-align:left;"><span><?= $data['VNAME'];?></span></td>
	<td style="text-align:right;"><span><?= number_format($data['NET'],2);?></span></td>
</tr>
<?PHP
}
?>
