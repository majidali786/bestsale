...
<div class="col-sm-4">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> From Location<span class="required">*</span></label>
<div class="col-md-12 show-error">
...
<div class="col-sm-4">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> To Location<span class="required">*</span></label>
<div class="col-md-12 show-error">
