...
<td>
<input type="text"  class="form-control move-enter-row enter-3" name="weight"  placeholder="Weight" data-required data-only-numbers   data-position="3">
</td>
<td>
...
<td>
<input type="text" data-required data-only-numbers greater-then-zero class="form-control move-enter-row enter-6 row-end" name="rate" placeholder="Rate"  data-position="6" >
</td>
