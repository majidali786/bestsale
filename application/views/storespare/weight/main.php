...
<span class="caption-subject font-white bold uppercase">Add Weight</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Weight">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Weight</span>
</div>
<div class="actions">
