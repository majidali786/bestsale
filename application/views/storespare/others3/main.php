...
<span class="caption-subject font-white bold uppercase">Add Others3</span>
</div>
</div>
...
<input type="text" class="form-control" name="name" placeholder="Others3">
</div>
</div>
...
<span class="caption-subject font-white bold uppercase">List Size</span>
</div>
<div class="actions">
