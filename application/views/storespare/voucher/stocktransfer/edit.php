...
<div class="col-sm-4">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> From Department<span class="required">*</span></label>
<div class="col-md-12 show-error">
<select name="fdepartment" id="fdepartment" class="form-control select2 move-enter-up move-enter-3" data-position="3">
...
<div class="col-sm-4">
<div class="form-group">
<label class="col-md-12 control-label lable-voucher"><i class="fa fa-caret-right theme-color" aria-hidden="true"></i> To Department<span class="required">*</span></label>
<div class="col-md-12 show-error">
<select name="tdepartment" id="tdepartment" class="form-control select2 move-enter-up move-enter-4" data-position="4">
...
<script>
$("[name=fdepartment]").val(<?= $data[0]['FDPCODE']?>);
$("[name=tdepartment]").val(<?= $data[0]['TDPCODE']?>);
