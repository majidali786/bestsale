...
<div class="col-md-12 show-error">
<input type="hidden" class="form-control" name="dpcode" readonly placeholder="Party Code">
...
<div class="col-md-12">
<input type="text" class="form-control move-enter-up move-enter-4" data-position="4" name="dono"  placeholder="Demand Order No.">
</div>
</div>
</div>
