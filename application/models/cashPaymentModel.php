<?php
	class cashPaymentModel extends MY_Model{
	...
	$gnrllgrAcc = $this->db->query("INSERT INTO $gnrllgr(No,VDate,Jo,ACode,Descr,Debit,Credit,B_ID,PNO) VALUES ('$no','$vdate','$voucher_Jo','$acode','$descrip',$debit,0,'".$this->userData['B_ID']."','$invno')");
	}
	}
